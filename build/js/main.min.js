...
var upwardButtonInit = function upwardButtonInit() {
  if (scrollButton) {
    window.addEventListener('scroll', function () {
      ...
      // eslint-disable-next-line no-console
      console.log("1. viewportHeight: ".concat(viewportHeight));
      // eslint-disable-next-line no-console
      console.log("2. scrollProgress: ".concat(scrollProgress));
      // eslint-disable-next-line no-console
      console.log("3. bodyHeight: ".concat(bodyHeight));
      // eslint-disable-next-line no-console
      console.log("4. footerHeight: ".concat(footerHeight));
      // eslint-disable-next-line no-console
      console.log("5. if ".concat(scrollProgress, " >= ").concat(heightBeforeFooter));
